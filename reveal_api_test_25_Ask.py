...
def run_ask(login_session_id):
   
    #1374 is case "Enron Summit 2024" in consulting
    ask_url = baseurl + "/rest/api/v2/1374/generativeai/search/semantic/v2"
    ...
    # Payload data
    payload = {"sessionId":"","message":{"messageText":"who is CFO of Enron\n","messageOwner":"USER"},"top":100}
    ...
    if ask_session_id is not None:
        print(f"sessionid: {ask_session_id}")
    else:
